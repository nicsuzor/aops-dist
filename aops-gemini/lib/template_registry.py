...
TEMPLATE_SPECS: dict[str, TemplateSpec] = {
    ...
    "task.block": TemplateSpec(
        ...
        required_vars=("task_bound_status", "hydrator_invoked_status", "critic_invoked_status", "missing_gates"),
    ...
    "task.warn": TemplateSpec(
        ...
        required_vars=("task_bound_status", "hydrator_invoked_status", "critic_invoked_status"),
