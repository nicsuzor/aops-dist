...
| [[user-intent-discovery]]                       | Hydration Gate: Read-Only Tool Bypass                 | `excluded_tool_categories=["always_available", "read_only"]` in GatePolicy — read-only tools never blocked by hydration gate | PreToolUse                     | Hard Gate |
