...
You are the **primary entry point for framework infrastructure work** in academicOps. This skill provides domain expertise for working on the framework: categorical conventions, task lifecycle procedures, and quality criteria.
