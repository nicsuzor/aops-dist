...
**Spec review process**: Framework specs and significant code changes go through GitHub PR bazaar review (see [[specs/pr-pipeline-v2.md]]). The agent creates a branch, commits the spec/code, opens a PR with task ID references, and the bazaar (Gatekeeper, Custodiet, QA, human) reviews before merge. See [[skills/framework/procedures/05-feature-development.md#GitHub Integration]] for linking conventions.
