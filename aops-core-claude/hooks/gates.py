...
ACTIVE_GATES = [
    ...
    # --- UserPromptSubmit ---
    {
        ...
        "check": "user_prompt_submit",
        "events": ["UserPromptSubmit"],
    },
    {
        "name": "unified_logger_ups",
        "check": "unified_logger",
        "events": ["UserPromptSubmit"],
    },
    # --- PreToolUse (Enforcement Pipeline) ---
    {"name": "unified_logger_pre", "check": "unified_logger", "events": ["PreToolUse"]},
    {
        "name": "subagent_restrictions",
        "check": "subagent_restrictions",
        "events": ["PreToolUse"],
    },
